    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 relative overflow-hidden flex flex-col items-center justify-center px-4 transition-colors duration-300">
        ...
        <div className="relative z-10 w-full max-w-4xl flex flex-col items-center">
          ...
          <div className="text-center mb-8 sm:mb-12 animate-slide-up">
            <div className="inline-block p-3 sm:p-4 rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 shadow-2xl dark:shadow-none mb-4 sm:mb-6">
              <span className="text-4xl sm:text-6xl filter drop-shadow-lg">📊</span>
            </div>
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-black text-slate-900 dark:text-white mb-3 sm:mb-4 tracking-tight">
              Deneme <span className="gradient-text">Takip</span>
            </h1>
            <p className="text-sm sm:text-lg text-slate-600 dark:text-slate-400 max-w-lg mx-auto font-medium px-4">
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                      <span className="text-3xl sm:text-5xl transform group-hover:scale-110 transition-transform duration-300 filter drop-shadow-md">
                        {style.icon}
                      </span>
                      <span className={`px-3 sm:px-4 py-1 sm:py-1.5 rounded-full text-[10px] sm:text-xs font-bold uppercase tracking-wider bg-slate-100 dark:bg-slate-800 ${style.text} shadow-sm dark:shadow-none`}>
                        {student.examType}
                      </span>
                    </div>
